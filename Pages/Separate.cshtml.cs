...
{
    public class SeparateModel : PageModel
    {
        ...
        public SeparateModel(ILogger<SeparateModel> logger)
        {
            _logger = logger;
        }
        ...
        public IActionResult OnPost()
        {
            ...
            var url = QueryHelpers.AddQueryString(AuthSettings.AuthorizationSeparateUri, dictionary);
